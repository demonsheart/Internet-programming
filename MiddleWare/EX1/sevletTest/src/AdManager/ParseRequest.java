...
public class ParseRequest {
    ...
    public Vector getFormData(HttpServletRequest req) throws ServletException, IOException {
    ...
    //解析表单数据并保存到vector中
    public Vector getFormData(ServletInputStream servletinputstream) throws ServletException, IOException {
        Vector formdatas = new Vector();
        FormData fd = null;
        int size = 2048000;//上传的文件的最大限制为2M
